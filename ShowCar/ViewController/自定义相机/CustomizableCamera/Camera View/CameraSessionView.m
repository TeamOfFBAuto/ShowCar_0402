...
#pragma mark - add by chaoweili
/**
 *  add by lichaowei
 */

- (void)clickToPhotos:(UIButton *)sender
{
//    [self onTapDismissButton];
    
    if ([self.delegate respondsToSelector:@selector(didOpenPhoto:)])
        [self.delegate didOpenPhoto:sender];
}
